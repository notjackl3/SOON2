...
export default function SectionConcept() {
  return (
    <section id="soon" className="relative w-full overflow-hidden">
      <div className="relative mx-auto w-full max-w-360">
        ...
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-12 px-8 md:px-34 md:py-16">
            ...
            <div className="flex flex-col gap-16 md:flex-row md:flex-wrap md:items-end md:justify-between md:gap-x-12 md:gap-y-16">
              ...
              <div className="flex max-w-160 flex-1 flex-col md:min-w-110">
                ...
                <Image
                  ...
                  height={667}
                  priority
                  className="h-auto w-full max-w-163.75"
                />
              </div>

              {/* right panel — arrow + image placeholder + stats */}
              <div className="flex w-full flex-col items-end gap-9 md:w-115.25 md:shrink-0">
                {/* eslint-disable-next-line @next/next/no-img-element -- decorative SVG */}
                <img
            ...
            <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
              ...
              <img
                ...
                alt=""
                aria-hidden
                className="h-56 w-86 self-end md:-mt-28 md:self-start"
              />
            </div>
